...
- SharePoint package version (`.sppkg`): `1.0.32.10` in `spfx/UniversalHtmlViewer/config/package-solution.json`.
- Web part manifest version: `1.0.25` in `spfx/UniversalHtmlViewer/src/webparts/universalHtmlViewer/UniversalHtmlViewerWebPart.manifest.json`.
