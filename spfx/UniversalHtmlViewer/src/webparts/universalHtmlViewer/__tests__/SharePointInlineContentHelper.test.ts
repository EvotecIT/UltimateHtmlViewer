...
describe('prepareInlineHtmlForSrcDoc', () => {
  it('injects base href and history compatibility shim when head exists', () => {
    ...
    const result = prepareInlineHtmlForSrcDoc(
      inputHtml,
      '/sites/TestUHV2/SiteAssets/GPOzaurr/',
      'https://evotecpoland.sharepoint.com/sites/TestUHV2/SitePages/Dashboard.aspx',
    );

    expect(result).toContain('data-uhv-history-compat="1"');
    expect(result).toContain(
      '<base href="https://evotecpoland.sharepoint.com/sites/TestUHV2/SiteAssets/GPOzaurr/">',
    );
  ...
  it('does not add duplicate base tag when one already exists', () => {
    const inputHtml =
      '<html><head><base href="https://evotecpoland.sharepoint.com/sites/TestUHV2/SiteAssets/GPOzaurr/"><title>Report</title></head><body></body></html>';
    const result = prepareInlineHtmlForSrcDoc(
      inputHtml,
      '/sites/TestUHV2/SiteAssets/GPOzaurr/',
      'https://evotecpoland.sharepoint.com/sites/TestUHV2/SitePages/Dashboard.aspx',
