...
const stringKeys = new Set<string>([
  ...
  'inlineCspScriptAllowedHosts',
  'inlineCspStyleAllowedHosts',
  'inlineCspImageAllowedHosts',
  'sandboxPreset',
  'iframeSandbox',
  'iframeAllow',
  'iframeReferrerPolicy',
...
export function buildConfigExport(
  ...
  return {
    ...
    inlineCspScriptAllowedHosts: props.inlineCspScriptAllowedHosts || '',
    inlineCspStyleAllowedHosts: props.inlineCspStyleAllowedHosts || '',
    inlineCspImageAllowedHosts: props.inlineCspImageAllowedHosts || '',
    ...
    inlineDeepLinkParamName: props.inlineDeepLinkParamName || 'uhvPage',
